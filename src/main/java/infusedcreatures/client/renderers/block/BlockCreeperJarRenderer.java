...
public class BlockCreeperJarRenderer extends BlockRenderer implements ISimpleBlockRenderingHandler {
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
        ...
        TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEssentiaReservoir(), 0.0D, 0.0D, 0.0D, 0.0F);
        GL11.glEnable(32826);
    }
